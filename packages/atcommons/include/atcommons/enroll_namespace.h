 ...
 */
int atcommons_enroll_namespace_to_json(char *ns_str, const size_t ns_str_size,
                                       size_t *ns_str_len,
 ...
 * @return int 0 on success, non-zero int on failure
 */
int atcommons_enroll_namespace_list_append(enroll_namespace_list_t **ns_list,
                                           enroll_namespace_t *ns);
