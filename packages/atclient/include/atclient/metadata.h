...
typedef struct atclient_atkey_metadata {
  ...
  atclient_atstr createdat;   // date and time representing when the key was created
  atclient_atstr updatedat;   // date and time representing when the key was last updated
  atclient_atstr
      datasignature; // public data is signed using the key owner's encryptPrivateKey and result is stored here
  atclient_atstr sharedkeystatus; // represents status of the [SharedKey]
...
int atclient_atkey_metadata_set_pubkeycs(atclient_atkey_metadata *metadata, const char *pubkeycs,
                                         const unsigned long pubkeycslen);
