...
void atclient_notify_params_init(atclient_notify_params *params) {
  ...
  memset(params->_initializedfields, 0, sizeof(params->_initializedfields));
}
...
bool atclient_notify_params_is_id_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ID_INDEX] & ATCLIENT_NOTIFY_PARAMS_ID_INITIALIZED;
}

bool atclient_notify_params_is_atkey_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ATKEY_INDEX] & ATCLIENT_NOTIFY_PARAMS_ATKEY_INITIALIZED;
}

bool atclient_notify_params_is_value_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_VALUE_INDEX] & ATCLIENT_NOTIFY_PARAMS_VALUE_INITIALIZED;
}

bool atclient_notify_params_is_shouldencrypt_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHOULD_ENCRYPT_INDEX] &
...
bool atclient_notify_params_is_operation_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_OPERATION_INDEX] &
...
bool atclient_notify_params_is_message_type_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_MESSAGE_TYPE_INDEX] &
...
bool atclient_notify_params_is_priority_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_PRIORITY_INDEX] &
...
bool atclient_notify_params_is_strategy_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_STRATEGY_INDEX] &
...
bool atclient_notify_params_is_latest_n_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_LATEST_N_INDEX] &
...
bool atclient_notify_params_is_notifier_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFIER_INDEX] &
...
bool atclient_notify_params_is_notification_expiry_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFICATION_EXPIRY_INDEX] &
...
bool atclient_notify_params_is_shared_encryption_key_initialized(atclient_notify_params *params) {
  return params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHARED_ENCRYPTION_KEY_INDEX] &
...
void atclient_notify_params_set_id_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ID_INDEX] |= ATCLIENT_NOTIFY_PARAMS_ID_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ID_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_ID_INITIALIZED;
  }
}
...
void atclient_notify_params_set_atkey_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ATKEY_INDEX] |= ATCLIENT_NOTIFY_PARAMS_ATKEY_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_ATKEY_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_ATKEY_INITIALIZED;
  }
}
...
void atclient_notify_params_set_value_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_VALUE_INDEX] |= ATCLIENT_NOTIFY_PARAMS_VALUE_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_VALUE_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_VALUE_INITIALIZED;
  }
}
...
void atclient_notify_params_set_shouldencrypt_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHOULD_ENCRYPT_INDEX] |=
        ATCLIENT_NOTIFY_PARAMS_SHOULD_ENCRYPT_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHOULD_ENCRYPT_INDEX] &=
        ~ATCLIENT_NOTIFY_PARAMS_SHOULD_ENCRYPT_INITIALIZED;
...
void atclient_notify_params_set_operation_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_OPERATION_INDEX] |= ATCLIENT_NOTIFY_PARAMS_OPERATION_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_OPERATION_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_OPERATION_INITIALIZED;
  }
}
...
void atclient_notify_params_set_message_type_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_MESSAGE_TYPE_INDEX] |=
        ATCLIENT_NOTIFY_PARAMS_MESSAGE_TYPE_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_MESSAGE_TYPE_INDEX] &=
        ~ATCLIENT_NOTIFY_PARAMS_MESSAGE_TYPE_INITIALIZED;
...
void atclient_notify_params_set_priority_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_PRIORITY_INDEX] |= ATCLIENT_NOTIFY_PARAMS_PRIORITY_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_PRIORITY_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_PRIORITY_INITIALIZED;
  }
}
...
void atclient_notify_params_set_strategy_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_STRATEGY_INDEX] |= ATCLIENT_NOTIFY_PARAMS_STRATEGY_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_STRATEGY_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_STRATEGY_INITIALIZED;
  }
}
...
void atclient_notify_params_set_latest_n_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_LATEST_N_INDEX] |= ATCLIENT_NOTIFY_PARAMS_LATEST_N_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_LATEST_N_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_LATEST_N_INITIALIZED;
  }
}
...
void atclient_notify_params_set_notifier_initialized(atclient_notify_params *params, const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFIER_INDEX] |= ATCLIENT_NOTIFY_PARAMS_NOTIFIER_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFIER_INDEX] &= ~ATCLIENT_NOTIFY_PARAMS_NOTIFIER_INITIALIZED;
  }
}
...
void atclient_notify_params_set_notification_expiry_initialized(atclient_notify_params *params,
  ...
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFICATION_EXPIRY_INDEX] |=
        ATCLIENT_NOTIFY_PARAMS_NOTIFICATION_EXPIRY_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_NOTIFICATION_EXPIRY_INDEX] &=
        ~ATCLIENT_NOTIFY_PARAMS_NOTIFICATION_EXPIRY_INITIALIZED;
...
void atclient_notify_params_set_shared_encryption_key_initialized(atclient_notify_params *params,
                                                                  const bool initialized) {
  if (initialized) {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHARED_ENCRYPTION_KEY_INDEX] |=
        ATCLIENT_NOTIFY_PARAMS_SHARED_ENCRYPTION_KEY_INITIALIZED;
  } else {
    params->_initializedfields[ATCLIENT_NOTIFY_PARAMS_SHARED_ENCRYPTION_KEY_INDEX] &=
        ~ATCLIENT_NOTIFY_PARAMS_SHARED_ENCRYPTION_KEY_INITIALIZED;
...
int atclient_notify_params_set_id(atclient_notify_params *params, const char *id, const size_t id_len) {
  ...
  if (id_len != 36) {
    ret = 1;
    atlogger_log(TAG, ATLOGGER_LOGGING_LEVEL_ERROR, "Invalid id length: %lu, should be a UUIDv4\n", id_len);
    goto exit;
  }
...
int atclient_notify_params_set_value(atclient_notify_params *params, const char *value, const size_t value_len) {
  ...
  if ((params->value = (char *)malloc(sizeof(char) * (value_len + 1))) == NULL) {
    ret = 1;
...
int atclient_notify_params_set_should_encrypt(atclient_notify_params *params, const bool should_encrypt) {
  ...
  atclient_notify_params_set_shouldencrypt_initialized(params, true);
  return 0;
}
...
int atclient_notify_params_set_notifier(atclient_notify_params *params, const char *notifier,
  ...
  if ((params->notifier = (char *)malloc(sizeof(char) * (notifier_len + 1))) == NULL) {
    ret = 1;
...
void atclient_notify_params_unset_should_encrypt(atclient_notify_params *params) {
  params->should_encrypt = true;
  atclient_notify_params_set_shouldencrypt_initialized(params, false);
}
