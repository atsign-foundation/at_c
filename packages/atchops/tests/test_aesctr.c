...
int main(int argc, char **argv)
{
    ...
    ret = atchops_aesctr_encrypt(aeskeybase64, strlen(aeskeybase64), ATCHOPS_AES_256, iv, (unsigned char *) plaintext, plaintextlen, ciphertext, ciphertextlen, &olen);
    ...
    memset(iv, 0, 16);
    ret = atchops_aesctr_decrypt(aeskeybase64, strlen(aeskeybase64), ATCHOPS_AES_256, iv , ciphertext, olen, plaintext2, plaintextlen2, &olen);
