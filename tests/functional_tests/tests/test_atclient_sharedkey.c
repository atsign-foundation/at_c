...
int main(int argc, char *argv[]) {
  ...
  if ((ret = functional_tests_set_up_atkeys(&atkeys1, atsign1)) != 0) {
    atlogger_log(TAG, ATLOGGER_LOGGING_LEVEL_ERROR, "set_up: %d\n", ret);
    goto exit;
  }

  if ((ret = functional_tests_pkam_auth(&atclient1, &atkeys1, atsign1)) != 0) {
    atlogger_log(TAG, ATLOGGER_LOGGING_LEVEL_ERROR, "set_up: %d\n", ret);
    goto exit;
  }
  ...
  if ((ret = functional_tests_set_up_atkeys(&atkeys2, atsign2) != 0)) {
    atlogger_log(TAG, ATLOGGER_LOGGING_LEVEL_ERROR, "set_up: %d\n", ret);
    goto exit;
  }

  if ((ret = functional_tests_pkam_auth(&atclient2, &atkeys2, atsign2)) != 0) {
    atlogger_log(TAG, ATLOGGER_LOGGING_LEVEL_ERROR, "set_up: %d\n", ret);
    goto exit;
  }
