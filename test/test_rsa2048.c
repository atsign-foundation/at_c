...
int main()
{
    ...
    RSA2048_PrivateKey *privatekeystruct = malloc(sizeof(RSA2048_PrivateKey));

    int ret = atchops_populate_privatekey(privatekeybase64, privatekeybase64len, privatekeystruct);
    printf("ret: %d\n", ret);
